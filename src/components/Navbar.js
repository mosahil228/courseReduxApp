                        ...
                        {userData.setUser[0] !== null && <div className='userLoggedIn' onClick={() => setHideInfo(!hideInfo)}>
                            ...
                            {hideInfo && <div className='userMenu'>
                                <div className='userMenuItems' style={{background:userData.darkMode.setDark?userData.darkMode.bgDark:""}}>
                                    <Link to={'/mycourses'}><div><h3 style={{color:userData.darkMode.setDark?userData.darkMode.textLight:""}}>My Enrollments</h3></div></Link>
                                    <Link to={'/'}><div><h3 style={{color:userData.darkMode.setDark?userData.darkMode.textLight:""}}>Favourites</h3></div></Link>
